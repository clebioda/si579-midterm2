...
const explanation = `Because celsius was not set as a state variable, React was not able to detect changes so we need to use useState instead which let's React know to rerender the celsius value`;
...
export function Problem () {
    ...
    const [celsius, setC] = useState(-40)
    //let celsius = -40;
